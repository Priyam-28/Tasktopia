            ...
            <section className="bg-gray-50 min-h-screen flex items-center justify-center">
                <div className="bg-gray-100 flex rounded-2xl shadow-lg max-w-3xl p-5 items-center">
                    <div className="md:w-1/2 px-8 md:px-16">
                        <h2 className="font-bold text-xl head_text">Sign Up</h2>
                        <p className="text-sm mt-4 orange_gradient">Register and Manage your tasks with ease.</p>
                        ...
                        <form className="flex flex-col gap-4" >
                            ...
                            <input className="p-2 mt-2 rounded-xl border"
                                type="text"
                                name="fullName"
                        ...
                        <button className="bg-white border py-2 w-full rounded-xl mt-5 flex justify-center items-center text-sm hover:scale-105 duration-300 text-[#002D74]" onClick={handleGoogleAuth}>
